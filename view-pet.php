            ...
            <div class="card mb-4">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <strong><?php echo $L['species'] ?? 'Species'; ?>:</strong> <?php echo ucfirst(htmlspecialchars($pet['species'])); ?>
                    </li>
                    <li class="list-group-item">
                        <strong><?php echo $L['breed'] ?? 'Breed'; ?>:</strong> <?php echo htmlspecialchars($pet['breed']); ?>
                    </li>
                    <li class="list-group-item">
                        <strong><?php echo $L['sex'] ?? 'Sex'; ?>:</strong> <?php echo ucfirst(htmlspecialchars($pet['sex'])); ?>
                    </li>
                    <li class="list-group-item">
